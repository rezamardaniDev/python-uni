...
while True:
    ...
    # اگر گزینه چهار رو وارد کرد، تابع مربوط به ویرایش اطلاعات اجرا میشه
    elif choices == "4":
        edit_student()

    # اگر گزینه پنج رو وارد کرد، تابع مربوط به جستجوی دانشحو اجرا میشه
    elif choices == "5":
        search_student()

    # اگر گزینه شش رو وارد کرد، تابع مربوط به مشاهده تعداد دانشجویان، میانگین نمرات و بالاترین نمره اجرا میشه
    elif choices == "6":
        show_detail()
